    ...
    <section>
      ...
      <div className="mt-10">
        <a
          ...
          className="group/link py-2 px-8 bg-[var(--color-mint-400)] text-[var(--color-background)] font-semibold rounded-full shadow-md hover:bg-[var(--color-mint-200)] focus-visible:bg-[var(--color-mint-200)] disabled:opacity-50 hover:cursor-pointer transition duration-200 ease-in-out text-base"
